...
# Convertir ambas columnas a mayúsculas y quitar tildes antes del merge
df_hoja1['Provincia'] = df_hoja1['Provincia'].apply(lambda x: quitar_tildes(x).upper())
df_provincia_sql['provincia'] = df_provincia_sql['provincia'].apply(lambda x: quitar_tildes(x).upper())
